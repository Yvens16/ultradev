...
const configuration = {
  site: {
    ...
    siteUrl: env.SITE_URL ||"ultradev-3jl1z1jlw-yvens16.vercel.app", // T-1849 Change this to your site URL
    siteName: 'UltraDev',
    twitterHandle: '',
    githubHandle: '',
    language: 'en',
    convertKitFormId: '',
    locale: env.DEFAULT_LOCALE, // T-1850 Change this to your locale
  },
  auth: {
